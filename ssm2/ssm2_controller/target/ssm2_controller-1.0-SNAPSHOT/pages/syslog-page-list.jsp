...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li>
								<a href="${pageContext.request.contextPath}/sysLog/findAll?page=1&size=${sysLogs.pageSize}" aria-label="Previous">首页</a>
							</li>
							...
							<c:forEach begin="1" end="${sysLogs.pages}" var="pageNum">
								<li><a href="${pageContext.request.contextPath}/sysLog/findAll?page=${pageNum}&size=${sysLogs.pageSize}">${pageNum}</a></li>
							</c:forEach>
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll?page=${sysLogs.pageNum+1}&size=${sysLogs.pageSize}">下一页</a></li>
							<li>
								<a href="${pageContext.request.contextPath}/sysLog/findAll?page=${sysLogs.pages}&size=${sysLogs.pageSize}" aria-label="Next">尾页</a>
							</li>
						</ul>
					</div>
		...
		<strong>Copyright &copy; 2019/9/11 <a
			href="http://www.itcast.cn">张政代码研究中心</a>.
