...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole?id=${user.id}" class="btn bg-olive btn-xs">添加用户</a>
												<a href="${pageContext.request.contextPath}/user/deleteUser?id=${user.id}" class="btn bg-olive btn-xs">删除角色</a>
			...
			<strong>Copyright &copy; 2019/9/8 <a
